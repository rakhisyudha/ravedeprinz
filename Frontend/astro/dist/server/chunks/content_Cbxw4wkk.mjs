...
var notes = [
	{
		...
		tag: "REFLECTION",
		text: "The culmination of love is grief, and yet we love, despite the inevitable"
	},
	{
		date: "02.01.25",
		title: "In Pursuit of Great We Failed to Do Good",
		tag: "REFLECTION",
		text: "The pursuit of greatness often leads us astray from what is truly important."
	},
	{
		date: "05.01.25",
		title: "Don't cry. You're perfect.",
		tag: "REFLECTION",
		text: "You are enough just as you are."
	}
];
//#endregion
export { work as a, skills as i, notes as n, projects as r, education as t };
